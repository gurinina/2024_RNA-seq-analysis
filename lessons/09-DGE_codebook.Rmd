...
ggplot(res_tableOE_tb) +
        ...
        # scale_y_continuous(limits = c(0,50)) + # if you want to zoom in
        theme_bw() +
...
ggraph(g, layout = 'fr') +  # Fruchterman-Reingold layout
  ...
  labs(title = "GO Terms Network")  # Title for the plot
...
# Now we'll show the group labels instead of the category labels, these are
emapplot(pwt, showCategory = 50, node_label = "group")

# Now we'll show all the labels
emapplot(pwt, showCategory = 30, node_label = "all", cex_label_group = 3, 
...
ssplot(pwt, showCategory = 50, node_label = "category", with_edge = FALSE, group_category = TRUE)

ssplot(pwt, showCategory = 50, node_label = "group", with_edge = TRUE, group_category = TRUE)


ssplot(pwt, showCategory = 50, node_label = "group", with_edge = FALSE, group_category = TRUE)


ssplot(pwt, showCategory = 50, node_label = "all", with_edge = FALSE, 
       group_category = TRUE) + theme(legend.position = "none")
```
...
dotplot(gseaGO, showCategory = 20, font.size = 14) 
...
emapplot(pwt, showCategory = 30, node_label = "all", cex_label_group = 3, 
         layout.params = list("mds")) + theme(legend.position = "none")
...
# runGORESP` requires a matrix of fitness values, we'll turn foldchanges into
# a matrix using `cbind`:
