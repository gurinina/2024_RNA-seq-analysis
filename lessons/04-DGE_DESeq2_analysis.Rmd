...
5. **Shrink Dispersions:** Use empirical Bayes shrinkage to stabilize dispersion estimates, particularly for low-count genes.
...
**Example**  
If your metadata includes **sex**, **age**, and **treatment** as shown below:
