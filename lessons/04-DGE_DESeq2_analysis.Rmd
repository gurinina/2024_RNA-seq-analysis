...
The design only has one covariate, **sampletype**, which is the condition of interest. This means that DESeq2 will test for differential expression between the two sample types, while adjusting for any other sources of variation in the data.

**Example**
Let's look at another example. Suppose you have metadata that includes **sex**, **age**, and **treatment** as shown below:
