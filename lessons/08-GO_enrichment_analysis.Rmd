...
**`n`**: The **number of genes in the background that are not annotated with the specific GO term**. It can be calculated as \( N m \), where \( N \) is the total number of genes in the background set.
