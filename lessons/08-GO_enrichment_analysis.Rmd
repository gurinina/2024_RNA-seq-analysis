...
Run this if you update your R version or need to install the required packages:
```{r}
...
#     "purrr", "RColorBrewer", "rmarkdown", "rsconnect", "tidyverse")
# )
```
...
# BiocManager::install(c("ggraph", "igrapgh", "visNetwork", "GO.db", "GOSemSim, "AnnotationDbi"))
