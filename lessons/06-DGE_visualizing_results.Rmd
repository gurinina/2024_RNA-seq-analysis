...
# Plot the MOV10 normalized counts, using the samplenames (rownames of d as labels)
...
In addition to plotting subsets, we could also extract the normalized values of *all* the significant genes from **Control vs. Mov10 overexpression** (control and overexpression) and plot a heatmap of their expression using `pheatmap()`.
