...
**Are there any outliers in the data?**
  ...
  - Ans: 
```{r, results = "asis", echo = FALSE}
solutions("Yes, sci8_rep2, ctrl_rep3 cluster away from their replicates")
```
...
```{r, results = "asis", echo = FALSE}
solutions("Yes, sci8 and sci16 don't separate well, the ctrls show big variations among replicates")
```
